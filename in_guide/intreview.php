...
<div class="container-fluid">
  ...
  <div class="panel-group" id="accordionjul">
    <div class="panel panel-default">
      ...
      <div id="week1july" class="panel-collapse collapse">
        ...
        $q2222 = mysql_query("select * from intern_review where g_id='".$_SESSION['uname']."' and (week='july1' and int_id='".$seloption."')")or die ('Query is invalid: ' . mysql_error());
        
        while ($row = mysql_fetch_array($q2222)) {
        	 
        	echo "<ul>".$row['message']." </ul>";
        }
  ...
  <button class="btn btn-default btn-success" type="submit" name="submitjw1">Submit</button>
       ...
       $kv1 = $_POST['kv'];
        ...
        {
        	$msg = "INSERT INTO `intern_review` (`int_id`, `g_id`, `message`,`week`,`status`,`postedby`) VALUES('$kv1','".$_SESSION['uname']."','$comment','july1','$option','$name')" ;
